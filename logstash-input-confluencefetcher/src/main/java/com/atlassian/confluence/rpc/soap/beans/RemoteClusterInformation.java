...
public class RemoteClusterInformation  implements java.io.Serializable {
    private com.atlassian.confluence.cluster.ClusterJoinConfig clusterJoinConfig;
    ...
    public RemoteClusterInformation(
           com.atlassian.confluence.cluster.ClusterJoinConfig clusterJoinConfig,
    ...
    /**
     * Gets the clusterJoinConfig value for this RemoteClusterInformation.
     * 
     * @return clusterJoinConfig
     */
    public com.atlassian.confluence.cluster.ClusterJoinConfig getClusterJoinConfig() {
        return clusterJoinConfig;
    }


    /**
     * Sets the clusterJoinConfig value for this RemoteClusterInformation.
     * 
     * @param clusterJoinConfig
     */
    public void setClusterJoinConfig(com.atlassian.confluence.cluster.ClusterJoinConfig clusterJoinConfig) {
        this.clusterJoinConfig = clusterJoinConfig;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        boolean _equals;
        _equals = true && 
            ((this.clusterJoinConfig==null && other.getClusterJoinConfig()==null) || 
             (this.clusterJoinConfig!=null &&
              this.clusterJoinConfig.equals(other.getClusterJoinConfig()))) &&
    ...
    public synchronized int hashCode() {
        ...
        __hashCodeCalc = true;
        int _hashCode = 1;
        if (getClusterJoinConfig() != null) {
            _hashCode += getClusterJoinConfig().hashCode();
        }
    ...
    static {
        ...
        elemField.setFieldName("clusterJoinConfig");
        elemField.setXmlName(new javax.xml.namespace.QName("", "clusterJoinConfig"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://cluster.confluence.atlassian.com", "ClusterJoinConfig"));
