...
public class RemoteContentPermissionSet  implements java.io.Serializable {
    ...
    public RemoteContentPermissionSet(
           com.atlassian.confluence.rpc.soap.beans.RemoteContentPermission[] contentPermissions,
     ...
     */
    public void setContentPermissions(com.atlassian.confluence.rpc.soap.beans.RemoteContentPermission[] contentPermissions) {
        this.contentPermissions = contentPermissions;
    }
